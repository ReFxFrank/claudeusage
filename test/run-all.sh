...
FAILED=0
for t in meters pricing codex-usage discord discord-presence effort-echo history statusline analytics model-families meters-polling alerts heatmap reach agents; do
  echo "=== $t ==="
